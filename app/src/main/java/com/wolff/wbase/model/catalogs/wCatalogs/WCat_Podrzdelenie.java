...
public class WCat_Podrzdelenie extends WCatalog implements Serializable {
    private Context mContext;
    private static final String CATALOG_TYPE = MetaCatalogs.MPodrazdelenie.CATALOG_NAME;
    public WCat_Podrzdelenie(Context context){
        mContext=context;
    }

    public WCat_Podrzdelenie(Context context, JSONObject jsonObject) {
