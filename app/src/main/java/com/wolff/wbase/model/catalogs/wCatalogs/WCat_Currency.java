...
public class WCat_Currency extends WCatalog implements Serializable {
    private Context mContext;
    private static final String CATALOG_TYPE = MetaCatalogs.MCurrency.CATALOG_NAME;
    public WCat_Currency(Context context){
        mContext=context;
    }

    public WCat_Currency(Context context, JSONObject jsonObject) {
        super(context,jsonObject);
        //mContext=context;
        Debug.Log("CREATE CURRENCY",""+this.getRef_Key()+"; "+this.getDescription());
    }
